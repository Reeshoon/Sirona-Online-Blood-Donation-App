 ...
 * @author USER
 */
public class policy2 extends javax.swing.JFrame {

    /**
     * Creates new form policy2
     */
    public policy2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 590, 930));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(policy2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
